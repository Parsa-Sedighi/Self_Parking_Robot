...
class Movement():
    def __init__(self):
        # --- Setup ---
        self.arduino = serial.Serial('/dev/ttyACM0', 9600, timeout=1) # ttyUSB0 may need to be changed to ttyACM0 use "sudo dmesg --follow" to determine the port of the ardiuno
